...
using OnlineCinemaTickets.Domain;
using OnlineCinemaTickets.Repository.Implementation;
using OnlineCinemaTickets.Repository.Interface;
using OnlineCinemaTickets.Repository;
using OnlineCinemaTickets.Services.Implementation;
using OnlineCinemaTickets.Services.Interface;
using OnlineCinemaTickets.Web.Data;
using Stripe;
using System;
...
using OnlineCinemaTickets.Services;

namespace OnlineCinemaTickets.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<OnlineCinemaUser>(options => options.SignIn.RequireConfirmedAccount = true)
